...
CREATE TABLE `mod_sources_messengers` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mod_sources_messengers_files` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `content` longblob,
  ...
  PRIMARY KEY (`id`),
  KEY `refid` (`refid`),
  CONSTRAINT `fk1_mod_sources_messengers_files` FOREIGN KEY (`refid`) REFERENCES `mod_sources_messengers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `mod_sources_messengers_categories` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `title` varchar(255) NOT NULL,
    `date_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
    `date_last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `mod_sources_messengers_categories_link` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk1_mod_sources_messengers_categories_link` FOREIGN KEY (`messenger_id`) REFERENCES `mod_sources_messengers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk2_mod_sources_messengers_categories_link` FOREIGN KEY (`category_id`) REFERENCES `mod_sources_messengers_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `mod_sources_messengers_messages` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `messenger_id` int unsigned NOT NULL,
    ...
    PRIMARY KEY (`id`),
    KEY `messenger_id` (`messenger_id`),
    CONSTRAINT `fk1_mod_sources_messengers_messages` FOREIGN KEY (`messenger_id`) REFERENCES `mod_sources_messengers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `mod_sources_messengers_messages_files` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `content` longblob,
    `refid` int unsigned NOT NULL,
    `filename` varchar(255) NOT NULL,
    ...
    PRIMARY KEY (`id`),
    KEY `refid` (`refid`),
    CONSTRAINT `fk1_mod_sources_messengers_messages_files` FOREIGN KEY (`refid`) REFERENCES `mod_sources_messengers_messages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `mod_sources_messengers_messages_reactions` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk1_mod_sources_messengers_messages_reactions` FOREIGN KEY (`message_id`) REFERENCES `mod_sources_messengers_messages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `mod_sources_messengers_subscribers` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
   `messenger_id` int unsigned NOT NULL,
   ...
   CONSTRAINT `fk1_mod_sources_messengers_subscribers` FOREIGN KEY (`messenger_id`) REFERENCES `mod_sources_messengers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


CREATE TABLE `mod_sources_messengers_content` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
